...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://ethio-mart-ten.vercel.app",
]
...
# ---------------------------------------------------------------------------
# Email Configuration (Brevo Transactional SMTP)
# ---------------------------------------------------------------------------
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="EthioMart <wudugetye12@gmail.com>")
